        ...
        <div className="flex flex-wrap justify-between">
          <div className="w-full md:w-1/3 mb-6 md:mb-0">
            ...
            <p className="text-white">
              ...
              <br /> and boundless knowledge. Explore our collection
              <br />
          ...
          <div className="w-full md:w-1/3 mb-6 md:mb-0">
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/" className="hover:text-accent_1 transition-colors">
                  Home
                </Link>
              </li>
              <li>
                <Link
                  to="/books"
                  className="hover:text-accent_1 transition-colors"
                >
                  Books
                </Link>
              </li>
