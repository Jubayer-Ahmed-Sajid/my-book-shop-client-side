  ...
  return (
    <div className="dropdown dropdown-bottom dropdown-left">
      ...
      >
        <li>
          <Link
            className="btn flex items-center border-none hover:bg-accent/80 gap-3 bg-accent text-white"
        ...
        <li>
          <button
            onClick={() => logout()}
            className="bg-error flex items-center gap-3 hover:bg-error/80 text-white border-none btn btn-md my-2"
          >
